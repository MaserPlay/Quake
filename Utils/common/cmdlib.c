...
qboolean isDirInPath(
    char *dir, char *path )  // DarkEssence: #bugfix not dirs in qdir path.
{
...
void Q_SecondsToDHMS( unsigned int elapsed_time, unsigned int *days,
